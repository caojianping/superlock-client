...
export class ProjectService {
    ...
    public async fetchProjectStats(): Promise<ProjectStatsModel | null> {
        return await Caxios.get<ProjectStatsModel | null>({ url: Urls.project.projectStats }, CaxiosType.Token);
    }

    // 获取资产统计信息
    public async fetchAssetStats(): Promise<AssetStatsModel | null> {
        return await Caxios.get<AssetStatsModel | null>({ url: Urls.project.assetStats }, CaxiosType.Token);
    }
