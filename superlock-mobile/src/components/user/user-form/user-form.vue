<template>
    <CellGroup class="space-large" :border="false">
        <Field class="field-mobile" :value="userForm.mobile" clearable placeholder="请输入手机号码" @input="handleFieldInput('mobile', $event)">
            <template slot="label">
                <AreaCode @change="handleAreaCodeChange" />
            </template>
        </Field>
