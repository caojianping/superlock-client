                    ...
                    <ant-col :span="18">
                        ...
                        >
                            <ant-input-number
                                ...
                                @change="
                                    handleFormChange('promotionRate', $event)
                                "
                    ...
                    <ant-col :span="18">
                        ...
                        >
                            <ant-input-number
                                ...
                                placeholder="请输入直推利率"
                                @change="
                                    handleFormChange('pushStraightRate', $event)
                                "
                                @keyup.enter="submit(false)"
                            />
                        </ant-form-item>
                        ...
                        >
                            <table class="award-table">
                                ...
                                <tbody>
                                    <tr
                                        v-for="(dailySale,
                                        index) in awardForm.dailySalesDto"
                                        :key="index"
                                    >
                                        <td>
                                            <ant-input-number
