<template>
    <div class="sl-container">
        <ant-breadcrumb class="sl-breadcrumb">
            ...
            <ant-breadcrumb-item>
                <router-link to="/finance/direct">直推奖励</router-link>
            </ant-breadcrumb-item>
        </ant-breadcrumb>

        <div class="sl-block">
            <header class="sl-block-header">
                <h2 class="sl-block-title">直推奖励列表</h2>
            </header>
        ...
        <ant-table :columns="columns" :rowKey="record => record.fundSerial" :dataSource="list" :pagination="false" :loading="isPageLoading">
            ...
            <span slot="proportion" slot-scope="record">
                {{ record.proportion | ratePercent }}
            </span>
...
<style src="./finance-direct.less" lang="less" scoped />

<script src="./finance-direct.ts" />
