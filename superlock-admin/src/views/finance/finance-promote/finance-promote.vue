<template>
    <div class="sl-container">
        <ant-breadcrumb class="sl-breadcrumb">
            ...
            <ant-breadcrumb-item>
                <router-link to="/finance/promote">推广奖励</router-link>
            </ant-breadcrumb-item>
        </ant-breadcrumb>

        <div class="sl-block">
            <header class="sl-block-header">
                <h2 class="sl-block-title">推广奖励列表</h2>
            </header>
        ...
        >
            ...
            <span slot="popularValue" slot-scope="record">
                {{ record.popularValue | digitPrecision(6) }}
            </span>
            ...
            <template slot="review" slot-scope="record">
                <template v-if="record.status === '0'">
                    <ant-button v-if="record.auditStatus !== '3'" type="default" size="small" @click="setReview(record.fundSerial, 3)">审核</ant-button>
                    <ant-button v-if="record.auditStatus === '1'" type="danger" size="small" @click="setReview(record.fundSerial, 5)">驳回</ant-button>
                </template>
            </template>
        </ant-table>
...
<style src="./finance-promote.less" lang="less" scoped />

<script src="./finance-promote.ts" />
