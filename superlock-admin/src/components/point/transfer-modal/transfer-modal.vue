<template>
    <ant-modal v-model="isShow" title="系统转账" :footer="null" @cancel="handleModalCancel">
        <ant-row :gutter="24">
            <ant-col :span="20">
                <ant-form-item label="上分账户ID" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
                    <ant-input type="text" :value="transferForm.fromId" disabled />
                </ant-form-item>
            </ant-col>
        </ant-row>
        ...
        <ant-row :gutter="24">
            <ant-col :span="20">
                <ant-form-item label="转账币种" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
                    <ant-select
        ...
        <ant-row :gutter="24">
            <ant-col :span="20">
                <ant-form-item label="可转余额" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
                    <ant-input type="text" :value="currentPointAccount.canused_amount" disabled />
                </ant-form-item>
            </ant-col>
        </ant-row>
        ...
        <ant-row :gutter="24">
            <ant-col :span="20">
                <ant-form-item label="收款账户ID" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
                    <ant-input type="text" :value="transferForm.toId" disabled />
                </ant-form-item>
            </ant-col>
        </ant-row>
        ...
        <ant-row :gutter="24">
            <ant-col :span="20">
                <ant-form-item label="收款账户类型" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
                    <ant-select
        ...
        <ant-row :gutter="24">
            <ant-col :span="20">
                <ant-form-item label="转账数量" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
                    <ant-input-number
