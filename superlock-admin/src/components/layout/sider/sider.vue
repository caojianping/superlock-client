    ...
    <div class="sider">
        <ul class="menus">
            <li class="menu-item" v-for="(menu, index) in menus" :key="index">
                ...
                <a
                    class="menu-link clearfix"
                    :class="{active: path.indexOf(menu.path) > -1}"
                    :href="route"
                ...
                >
                    <li
                        class="submenu-item"
                        v-for="(submenu, sindex) in submenus"
                        :key="sindex"
                    >
                        {{ (sroute = submenu.route ? '#' + submenu.route: 'javascript: void(0)', void 0) }}
                        <a
                            class="submenu-link"
                            :class="{active: path.indexOf(submenu.route) > -1}"
                            :href="sroute"
                        >
