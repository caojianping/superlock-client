...
export class FinanceService {
    ...
    // 获取利息支出分页列表
    public async fetchPageFinanceInterests(
        parameters: IPageParameters<IFinancePageParameters>
    ): Promise<PageResult<FinanceInterestModel>> {
        let url = Urls.finance.interest.page,
    ...
    // 导出利息支出
    public async exportFinanceInterests(
        parameters: IPageParameters<IFinancePageParameters>
    ): Promise<string> {
    ...
    // 获取直推奖励分页列表
    public async fetchPageFinanceDirects(
        parameters: IPageParameters<IFinancePageParameters>
    ): Promise<PageResult<FinanceDirectModel>> {
        let url = Urls.finance.direct.page,
    ...
    // 导出直推奖励
    public async exportFinanceDirects(
        parameters: IPageParameters<IFinancePageParameters>
    ): Promise<string> {
    ...
    // 获取推广奖励分页列表
    public async fetchPageFinancePromotes(
        parameters: IPageParameters<IFinancePageParameters>
    ): Promise<PageResult<FinancePromoteModel>> {
        let url = Urls.finance.promote.page,
    ...
    // 导出推广奖励
    public async exportFinancePromotes(
        parameters: IPageParameters<IFinancePageParameters>
    ): Promise<string> {
    ...
    // 获取日销奖励分页列表
    public async fetchPageFinanceSales(
        parameters: IPageParameters<IFinancePageParameters>
    ): Promise<PageResult<FinanceSaleModel>> {
        let url = Urls.finance.sale.page,
    ...
    // 导出日销奖励
    public async exportFinanceSales(
        parameters: IPageParameters<IFinancePageParameters>
    ): Promise<string> {
